...
public class QueryBuilder {
     ...
     * @return
     */
    static public String buildQuery(String date_from, String date_till, ArrayList<String> devices){
        ...
        return String.format("SELECT x, y FROM positions WHERE %", dateClause);
    }
     ...
     * @return
     */
    static public String buildQuery(String time, long time_amount, ArrayList<String> devices){
     ...
     * @return Part of where clause query
     */
    static private String buildDateClause(String time, long time_amount){
     ...
     * @return
     */
    static private String buildDevicesClause(ArrayList<String> devices){
